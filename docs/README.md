...
- [`history/CATCHUP.md`](history/CATCHUP.md) - older session catchup about audio/API simplification.
- [`history/HANDOFF.md`](history/HANDOFF.md) - dashboard/header refresh handoff.
- [`history/SYNTHESIS_NOTES.md`](history/SYNTHESIS_NOTES.md) - broader lineage and platform vision notes.
